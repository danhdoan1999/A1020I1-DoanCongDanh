...
public class Employee {
    ...
    public Employee(String name, String birthday, String idCard, String salary, String phone, String email, String address, String position, String educationDegree, String division, String username) {
        this.name = name;
        this.birthday = birthday;
        this.idCard = idCard;
        this.salary = salary;
